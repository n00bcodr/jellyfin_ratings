...
(function settingsMenu(){
  ...
  #mdbl-panel .mdbl-section + .mdbl-section{border-top:1px solid rgba(255,255,255,0.08);}
  .grid-right{display:flex;align-items:center;gap:8px;justify-content:flex-end;}
  .grid-right .sw{order:0;}
  .grid-right select.mdbl-select{order:1;min-width:var(--mdbl-right-col-wide);}`;
