...
(function settingsMenu(){
  ...
  @media (max-width: 540px){
    :root { --mdbl-right-col: 40px; --mdbl-right-col-wide: 60vw; }
    #mdbl-panel{
    ...
    .mdbl-section{padding:12px;}
    .mdbl-row{gap:10px;}
    .mdbl-row.wide{display:grid;grid-template-columns:1fr;align-items:start;}
    .mdbl-row.wide > span{margin-bottom:6px;}
    .mdbl-select{width:100%;}
    .mdbl-grid .grid-row{grid-template-columns:1fr;}
    .grid-right{justify-content:flex-start;}
    #mdbl-close{font-size:20px;padding:8px;margin-right:-4px;}
  }
`;
