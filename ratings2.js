...
/* --- Compactness Levels (attribute-driven, no layout breakage) --- */
#mdbl-panel[data-compact="1"]{
  --mdbl-right-col:44px; --mdbl-right-col-wide:160px;
...
#mdbl-panel[data-compact="1"] .mdbl-section{ padding:10px 12px; gap:8px; }
#mdbl-panel[data-compact="1"] .mdbl-row,
#mdbl-panel[data-compact="1"] .mdbl-source{ gap:8px; padding:6px 8px; border-radius:10px; }
...
#mdbl-panel[data-compact="1"] .mdbl-actions{ padding:8px 12px; }
#mdbl-panel[data-compact="1"] button{ padding:8px 10px; font-size:13px; }
#mdbl-panel[data-compact="1"] #mdbl-key-box{ padding:8px; border-radius:10px; }
#mdbl-panel[data-compact="1"] .mdbl-grid{ gap:8px; }
#mdbl-panel[data-compact="1"] .mdbl-grid .grid-row{ gap:10px; }
...
#mdbl-panel[data-compact="1"] .mdbl-subtle{ font-size:11.5px; }
#mdbl-panel[data-compact="1"] hr{ margin:8px 0; }

#mdbl-panel[data-compact="2"]{
  --mdbl-right-col:40px; --mdbl-right-col-wide:148px;
  width:410px; max-height:78vh;
}
#mdbl-panel[data-compact="2"] header{ padding:6px 10px; }
#mdbl-panel[data-compact="2"] header h3{ font-size:13px; }
#mdbl-panel[data-compact="2"] .mdbl-section{ padding:8px 10px; gap:6px; }
#mdbl-panel[data-compact="2"] .mdbl-row,
#mdbl-panel[data-compact="2"] .mdbl-source{ gap:6px; padding:5px 6px; border-radius:8px; }
#mdbl-panel[data-compact="2"] .mdbl-row.wide{ grid-template-columns:1fr var(--mdbl-right-col-wide); }
#mdbl-panel[data-compact="2"] input[type="checkbox"]{ transform:scale(0.95); }
#mdbl-panel[data-compact="2"] .mdbl-src-left img{ height:15px; }
#mdbl-panel[data-compact="2"] .mdbl-src-left .name{ font-size:12px; }
#mdbl-panel[data-compact="2"] input[type="text"]{ font-size:13px; padding:8px 0; }
#mdbl-panel[data-compact="2"] .mdbl-actions{ padding:6px 10px; }
#mdbl-panel[data-compact="2"] button{ padding:7px 8px; font-size:12.5px; }
#mdbl-panel[data-compact="2"] hr{ margin:6px 0; }

/* Actions bar layout (keeps Reset left; Compact+Save right) */
#mdbl-panel .mdbl-actions{ display:flex; align-items:center; gap:8px; }
#mdbl-panel .mdbl-actions .mdbl-grow{ flex:1; }
#mdbl-panel .mdbl-actions .mdbl-compact{ display:inline-flex; align-items:center; gap:6px; opacity:0.9; }
#mdbl-panel .mdbl-actions .mdbl-compact select{ min-width:120px; }
`;
  ...
  panel.innerHTML=`
    ...
    <div class="mdbl-actions">
      ...
      <label class="mdbl-compact">
        <span>Compact</span>
        <select id="mdbl-compact" class="mdbl-select">
...
// Sources
    ...
    mdblUpdateSwatches();
    // Compactness selector: reflect saved value + live preview via data-attribute
    const _cmpSel = panel.querySelector('#mdbl-compact');
    if (_cmpSel){
      _cmpSel.value = String((DISPLAY.compactLevel ?? 0));
      panel.setAttribute('data-compact', _cmpSel.value);
      _cmpSel.addEventListener('change', e=>{
        panel.setAttribute('data-compact', e.target.value);
      });
    }
  }
  ...
  panel.querySelector('#mdbl-btn-save').addEventListener('click', ()=>{
    ...
    prefs.display.compactLevel = +panel.querySelector('#mdbl-compact').value;
