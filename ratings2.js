...
(function settingsMenu(){
  ...
  #mdbl-panel select, #mdbl-panel input[type="number"].mdbl-select{padding:8px 10px;border-radius:10px;border:1px solid rgba(255,255,255,0.15);background:#121317;color:#eaeaea;justify-self:end}
...
/* === Typography normalization & control matching (injected) === */
...
/* Make numeric threshold inputs look like selects and align width */
#mdbl-panel input[type="number"].mdbl-select{ width:90px; }
...
#mdbl-panel[data-compact="1"] .mdbl-num{ font-size: inherit; }
...
// Sources
    ...
    dWrap.innerHTML=`
      ...
      <div class="mdbl-grid">
        <div class="grid-row">
          <label>Rating ≤ <input id="th_red" type="number" min="0" max="100" value="${(DISPLAY.colorBands&&DISPLAY.colorBands.redMax)!=null?DISPLAY.colorBands.redMax:50}" class="mdbl-num mdbl-select"> %</label>
        ...
        <div class="grid-row">
          <label>Rating ≤ <input id="th_orange" type="number" min="0" max="100" value="${(DISPLAY.colorBands&&DISPLAY.colorBands.orangeMax)!=null?DISPLAY.colorBands.orangeMax:69}" class="mdbl-num mdbl-select"> %</label>
          <div class="grid-right">
        ...
        <div class="grid-row">
          <label>Rating ≤ <input id="th_yg" type="number" min="0" max="100" value="${(DISPLAY.colorBands&&DISPLAY.colorBands.ygMax)!=null?DISPLAY.colorBands.ygMax:79}" class="mdbl-num mdbl-select"> %</label>
          <div class="grid-right">
